  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | GenuinePharmacy",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/GenuinePharmacy",
          instagram: "https://instagram.com/GenuinePharmacy",
          twitter: "https://twitter.com/GenuinePharmacy",
        },
      };
    ...
    const contactInfo = {
      ...
      phone: "+91 8053210008",
      email: "connect.GenuinePharmacy@gmail.com",
      ...
      metaTitle: "Contact Us | GenuinePharmacy",
      metaDescription:
