...
<head>
    ...
    <title>Verify Your Email - GenuinePharmacy</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Welcome to GenuinePharmacy</h1>
        </div>
        <div class="content">
            <h2>Verify Your Email</h2>
            <p>Dear Valued Customer,</p>
            <p>Welcome to GenuinePharmacy - your trusted source for premium quality supplements. Please verify your email address to access your account:</p>
            ...
            <p>If you didn't create an account with GenuinePharmacy, please disregard this email.</p>
        ...
        <div class="footer">
            © ${new Date().getFullYear()} GenuinePharmacy | Premium Health Supplements<br>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Your One-Time Password (OTP) - GenuinePharmacy</title>
    <style>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Dear Valued Customer,</p>
                <p>Use the following One-Time Password (OTP) to verify your email for GenuinePharmacy:</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Password - GenuinePharmacy</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear Valued Customer,</p>
            <p>We received a request to reset the password for your GenuinePharmacy account. Click the button below to create a new password:</p>
            <a href="${resetLink}" class="button">Reset Password</a>
            <p>If you didn't request this password reset, please contact our support team immediately at support@GenuinePharmacy</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Confirmation - GenuinePharmacy</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    ...
    data.orderDate
        ...
        <div class="footer">
            © ${new Date().getFullYear()} GenuinePharmacy | Premium Health Supplements<br>
            Questions? Contact our customer support at support@GenuinePharmacy
        </div>
    </div>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Partner Password - GenuinePharmacy</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Password Reset Request</h2>
            <p>Dear Partner,</p>
            <p>We received a request to reset the password for your GenuinePharmacy Partner account. Click the button below to create a new password:</p>
        ...
        <div class="footer">
            © ${new Date().getFullYear()} GenuinePharmacy | Partner Portal<br>
            This is an automated message. Please do not reply to this email.
        </div>
    </div>
</body>
