          ...
          >
            <div className="absolute inset-0 bg-gray-900/80 z-10 flex items-center justify-center">
              <div className="text-white p-12 max-w-md">
                ...
                <Link href="/about">
                  <button className="px-6 py-3 bg-white text-gray-900 font-semibold rounded-full hover:bg-primary hover:text-white transition-colors duration-300">
                    LEARN MORE
                  </button>
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 bg-white border-b-2 border-primary hover:shadow-lg transition-all duration-300"
              >
